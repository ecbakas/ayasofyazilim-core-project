"use server";
import type { GetApiAccountMyProfileResponse } from "@ayasofyazilim/core-saas/AccountService";
import { AccountServiceClient } from "@ayasofyazilim/core-saas/AccountService";
import type { User } from "next-auth";
import { isApiError, structuredError, structuredResponse } from "../api";
import { signIn, signOut } from "./auth";
import { getAccountServiceClient } from ".";
...
export async function signUpServer({
  ...
  try {
    ...
    const dataResponse = await client.account.postApiAccountRegister({
      requestBody: {
        userName,
        emailAddress: email,
        password,
