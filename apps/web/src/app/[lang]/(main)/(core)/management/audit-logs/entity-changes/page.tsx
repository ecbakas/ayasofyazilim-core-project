...
export default async function Page({
  ...
  const auditLogsEntityChangesResponse = await getAuditLogsEntityChangesApi(searchParams);
  if (isErrorOnRequest(auditLogsEntityChangesResponse, lang, false)) {
    return <ErrorComponent languageData={languageData} message={auditLogsEntityChangesResponse.message} />;
  }
